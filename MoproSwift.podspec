#
#  Be sure to run `pod spec lint MoproSwift.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "MoproSwift"
  spec.version      = "0.3.0"
  spec.summary      = "A Swift SDK that wraps Mopro bindings for use in iOS apps."
...
Provides a Swift SDK that wraps Mopro bindings for use in iOS applications.
  ...
  spec.source       = { :git => "https://github.com/zkmopro/mopro-swift-package.git", :tag => "v0.3.0" }
